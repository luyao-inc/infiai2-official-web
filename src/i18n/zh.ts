...
export const zh: Messages = {
  ...
  ui: {
    ...
    iosWechatTitle: '请在系统浏览器中打开 App Store',
    iosWechatBody: '微信可能限制网页直接唤起 App Store，请按下面步骤继续下载。',
    iosWechatSteps: ['点击微信右上角“…”', '选择“在默认浏览器中打开”', '在浏览器中点击 App Store 下载'],
    iosWechatTryOpen: '尝试打开 App Store',
    iosWechatCopy: '复制 App Store 链接',
    iosWechatCopied: '链接已复制',
    iosWechatCopyFailed: '复制失败，请长按下方链接复制',
